...
<div class="th-hero-wrapper hero-1" id="hero" data-bg-src="monlapin/assets/img/hero/hero_bg_1_2.jpg">
        ...
        <div class="swiper-wrapper">
                ...
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style1">
                            <span class="sub-title" data-ani="slideinup" data-ani-delay="0.2s"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">100% Quality Foods</span>
                            <h1 class="hero-title">
                                <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img class="title-img" src="monlapin/assets/img/hero/hero_title_shape.svg" alt="icon">
                    ...
                    <div class="hero-img" data-ani="slideinright" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_1_1.png" alt="Image">
                    </div>
                    <div class="hero-shape1" data-ani="slideinup" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_shape_1_1.png" alt="shape">
                    </div>
                    <div class="hero-shape2" data-ani="slideindown" data-ani-delay="0.6s">
                        <img src="monlapin/assets/img/hero/hero_shape_1_2.png" alt="shape">
                    </div>
                    <div class="hero-shape3" data-ani="slideinleft" data-ani-delay="0.7s">
                        <img src="monlapin/assets/img/hero/hero_shape_1_3.png" alt="shape">
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style1">
                            <span class="sub-title" data-ani="slideinup" data-ani-delay="0.2s"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">100% Organic Foods</span>
                            <h1 class="hero-title">
                                <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img class="title-img" src="monlapin/assets/img/hero/hero_title_shape.svg" alt="icon">
                    ...
                    <div class="hero-img" data-ani="slideinright" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_1_2.png" alt="Image">
                    </div>
                    <div class="hero-shape1" data-ani="slideinup" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_shape_1_1.png" alt="shape">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style1">
                            <span class="sub-title" data-ani="slideinup" data-ani-delay="0.2s"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">100% Fresh Foods</span>
                            <h1 class="hero-title">
                                <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                    <img class="title-img" src="monlapin/assets/img/hero/hero_title_shape.svg" alt="icon">
                    ...
                    <div class="hero-img" data-ani="slideinright" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_1_3.png" alt="Image">
                    </div>
                    <div class="hero-shape1" data-ani="slideinup" data-ani-delay="0.5s">
                        <img src="monlapin/assets/img/hero/hero_shape_1_1.png" alt="shape">
                    </div>
    ...
    <div class="hero-shape4">
        <img class="svg-img" src="monlapin/assets/img/hero/hero_shape_1_4.svg" alt="shape">
    </div>
</div>
<!--======== / Hero Section ========-->
<!--==============================
...
<section class="space-top">
    <div class="container">
        <div class="title-area text-center">
            <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="Icon">Categorie</span>
            <h2 class="sec-title">Nos produits frais</h2>
        </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="category-card">
                        <div class="box-shape" data-bg-src="monlapin/assets/img/bg/category_card_bg.png"></div>
                        <div class="box-icon" data-mask-src="monlapin/assets/img/bg/category_card_icon_bg.png">
                            <img src="monlapin/assets/img/icon/category_card_1.svg" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card">
                        <div class="box-shape" data-bg-src="monlapin/assets/img/bg/category_card_bg.png"></div>
                        <div class="box-icon" data-mask-src="monlapin/assets/img/bg/category_card_icon_bg.png">
                            <img src="monlapin/assets/img/icon/category_card_2.svg" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card">
                        <div class="box-shape" data-bg-src="monlapin/assets/img/bg/category_card_bg.png"></div>
                        <div class="box-icon" data-mask-src="monlapin/assets/img/bg/category_card_icon_bg.png">
                            <img src="monlapin/assets/img/icon/category_card_3.svg" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card">
                        <div class="box-shape" data-bg-src="monlapin/assets/img/bg/category_card_bg.png"></div>
                        <div class="box-icon" data-mask-src="monlapin/assets/img/bg/category_card_icon_bg.png">
                            <img src="monlapin/assets/img/icon/category_card_4.svg" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card">
                        <div class="box-shape" data-bg-src="monlapin/assets/img/bg/category_card_bg.png"></div>
                        <div class="box-icon" data-mask-src="monlapin/assets/img/bg/category_card_icon_bg.png">
                            <img src="monlapin/assets/img/icon/category_card_5.svg" alt="Image">
                        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 mb-30 mb-xl-0">
                <div class="img-box1">
                    <div class="img1">
                        <img src="monlapin/assets/img/normal/about_1_1.jpg" alt="About">
                    </div>
                    <div class="img2">
                        <img src="monlapin/assets/img/normal/about_1_2.jpg" alt="Image">
                    </div>
                    <div class="shape1 movingX">
                        <img src="monlapin/assets/img/normal/about_1_3.png" alt="Image">
                    </div>
            ...
            <div class="col-xl-6">
                <div class="ps-xxl-5 ps-xl-2 ms-xl-1 text-center text-xl-start">
                    <div class="title-area mb-32">
                        <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">Qui somme nous?</span>
                    ...
                    <div>
                        <a href="about.html" class="th-btn">Lire +<i class="fas fa-chevrons-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="" data-pos-for="#shop-sec" data-sec-pos="bottom-half">
    <div class="container z-index-common">
        <div class="row gy-30">
            <div class="col-xl-6">
                <div class="offer-card mega-hover" data-bg-src="monlapin/assets/img/bg/cta_bg_1_1.jpg">
                    <span class="h6 box-subtitle">Crea  <span class="text-theme">pub1</span></span>
            ...
            <div class="col-xl-6">
                <div class="offer-card mega-hover" data-bg-src="monlapin/assets/img/bg/cta_bg_1_2.jpg">
                    <span class="h6 box-subtitle">Crea <span class="text-theme">pub 2</span></span>
...
<section class="bg-smoke2 space" id="shop-sec">
    <div class="shape-mockup" data-top="0" data-left="0"><img src="monlapin/assets/img/shape/vector_shape_1.png" alt="shape"></div>
    <div class="shape-mockup" data-bottom="0" data-right="0"><img src="monlapin/assets/img/shape/vector_shape_2.png" alt="shape"></div>
        ...
        <div class="row">
            <div class="col-xl-6 text-center text-xl-start">
                <div class="title-area">
                    <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">Pourquoi nous choissir?</span>
                ...
                <div class="row">
                    <div class="col-xl-7">
                        <div class="choose-feature-wrap">
                            <div class="choose-feature">
                                <div class="box-icon">
                                    <img src="monlapin/assets/img/icon/choose_feature_1.svg" alt="Icon">
                                </div>
                            ...
                            <div class="choose-feature">
                                <div class="box-icon">
                                    <img src="monlapin/assets/img/icon/choose_feature_2.svg" alt="Icon">
                                </div>
                            ...
                            <div class="choose-feature">
                                <div class="box-icon">
                                    <img src="monlapin/assets/img/icon/choose_feature_3.svg" alt="Icon">
                                </div>
                            ...
                            <div class="choose-feature">
                                <div class="box-icon">
                                    <img src="monlapin/assets/img/icon/choose_feature_4.svg" alt="Icon">
                                </div>
                    ...
                    <div class="col-xl-5 d-none d-xl-block">
                        <div class="img-box2-wrap">
                            <div class="img-box2">
                                <div class="img1">
                                    <img src="monlapin/assets/img/normal/why_1_1.png" alt="Why">
                                </div>
                                <div class="img2">
                                    <img src="monlapin/assets/img/normal/why_1_2.png" alt="Why">
                                </div>
                            </div>
                        </div>
                    </div>
...
Counter Area
==============================-->
<div class="counter-sec1" data-bg-src="monlapin/assets/img/bg/counter_bg_1.png">
    <div class="container">
        <div class="counter-card-wrap">
            <div class="counter-card">
                <div class="box-icon">
                    <img src="monlapin/assets/img/icon/counter_card_1.svg" alt="Icon">
                </div>
            ...
            <div class="counter-card">
                <div class="box-icon">
                    <img src="monlapin/assets/img/icon/counter_card_2.svg" alt="Icon">
                </div>
                <div class="media-body">
            ...
            <div class="counter-card">
                <div class="box-icon">
                    <img src="monlapin/assets/img/icon/counter_card_3.svg" alt="Icon">
                </div>
                <div class="media-body">
            ...
            <div class="counter-card">
                <div class="box-icon">
                    <img src="monlapin/assets/img/icon/counter_card_4.svg" alt="Icon">
                </div>
                <div class="media-body">
...
Deal Area
==============================-->
<section class="bg-top-center space-top" data-bg-src="monlapin/assets/img/bg/deal_bg_1.jpg">
    <div class="container">
        <div class="title-area text-center">
            <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="Icon">Nos promotion</span>
            <h2 class="sec-title text-white">Week end suprise!</h2>
        </div>
        <div class="row gy-40 justify-content-center">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-product product-deal">
                    <div class="product-img">
                        <img src="monlapin/assets/img/product/deal_card_2.jpg" alt="Product Image">
                        <div class="actions">
                            <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                            <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                            <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-product product-deal">
                    <div class="product-img">
                        <img src="monlapin/assets/img/product/deal_card_3.jpg" alt="Product Image">
                        <div class="actions">
                            <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                            <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                            <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
    ...
    <div class="container z-index-common">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-8">
                <div class="title-area text-center">
                    <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="Icon">Nos membres</span>
        ...
        <div class="row gy-40 justify-content-center">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    <div class="img-wrap">
                        <div class="shape" data-mask-src="monlapin/assets/img/bg/team_card_bg.png"></div>
                        <div class="team-img">
                            <img src="monlapin/assets/img/team/team_1_1.jpg" alt="Team">
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    <div class="img-wrap">
                        <div class="shape" data-mask-src="monlapin/assets/img/bg/team_card_bg.png"></div>
                        <div class="team-img">
                            <img src="monlapin/assets/img/team/team_1_2.jpg" alt="Team">
                        </div>
                    </div>
                    <div class="box-content">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="th-team team-card">
                    <div class="img-wrap">
                        <div class="shape" data-mask-src="monlapin/assets/img/bg/team_card_bg.png"></div>
                        <div class="team-img">
                            <img src="monlapin/assets/img/team/team_1_3.jpg" alt="Team">
                        </div>
                    </div>
                    <div class="box-content">
                        <span class="team-desig">Senior Farmers</span>
...
<section class="overflow-hidden bg-smoke2" id="testi-sec">
    <div class="shape-mockup testi-shape1" data-top="0" data-left="0"><img src="monlapin/assets/img/normal/testi_shape.png" alt="shape"></div>
    <div class="shape-mockup" data-bottom="0" data-right="0"><img src="monlapin/assets/img/shape/vector_shape_5.png" alt="shape"></div>
    <div class="container">
        <div class="testi-card-area">
            <div class="title-area">
                <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="Icon">Avis clientels</span>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="testi-card">
                                ...
                                <div class="testi-card_profile">
                                    <div class="testi-card_avater">
                                        <img src="monlapin/assets/img/testimonial/testi_1_1.jpg" alt="Avater">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testi-card">
                                ...
                                <div class="testi-card_profile">
                                    <div class="testi-card_avater">
                                        <img src="monlapin/assets/img/testimonial/testi_1_2.jpg" alt="Avater">
                                    </div>
                                    <div class="testi-card_content">
...
<section class="space" id="blog-sec">
    <div class="container">
        <div class="title-area text-center">
            <span class="sub-title"><img src="monlapin/assets/img/theme-img/title_icon.svg" alt="shape">Blog</span>
            ...
            <div class="swiper th-slider has-shadow" id="blogSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"}}}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img">
                                <img src="monlapin/assets/img/blog/blog_1_1.jpg" alt="blog image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img">
                                <img src="monlapin/assets/img/blog/blog_1_2.jpg" alt="blog image">
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img">
                                <img src="monlapin/assets/img/blog/blog_1_3.jpg" alt="blog image">
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            <div class="blog-img">
                                <img src="monlapin/assets/img/blog/blog_1_4.jpg" alt="blog image">
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.html"><i class="far fa-user"></i>By Frutin</a>
