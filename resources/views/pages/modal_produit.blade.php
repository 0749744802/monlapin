...
<!-- fin modal-->
<!-- modal sous categorie page -->
<div class="modal fade" id="sous_categorie_page" tabindex="-1"
aria-labelledby="exampleModalgridLabel" aria-modal="true">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="{{ route('Store_sous_categorie_produitController') }}" method="POST">
                @csrf
                <div class="row g-3">
                    <div class="col-xxl-6">
                        <div>
                    ...
                    <div class="col-xxl-6">
                        <div>
                            <label for="lastName" class="form-label">Categorie secondaire</label>
                            <input type="text" class="form-control"
                                id="lastName" placeholder="..." name="titre_sous_categorie_produit">
                        </div>
                    </div><!--end col-->
